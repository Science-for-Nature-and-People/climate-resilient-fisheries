...
# new attrib file from chris 4/12/2022
attribs_new <- readRDS(here("case_study_analysis", "clean_data","case_study_attribute_score_data.Rds")) 
```

```{r}
attribs <- attribs_new %>% 
  mutate(attribute_id = str_c(dimension, attribute, sep = "::"))

attribs$attribute_id
```
