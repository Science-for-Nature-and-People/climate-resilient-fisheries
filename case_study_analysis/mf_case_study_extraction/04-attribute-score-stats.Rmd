...
group10_2 <- data %>% 
  select(case_study, attribute, score) %>% 
  filter(attribute %in% c("Economic diversity", "Economic opportunity"))
...
ggplot(group10_2, aes(x=case_study, y=score, fill=attribute)) +
  geom_col(stat="identity", position="dodge", color="navy", width=0.7) +
  theme_bw() + my_theme1 +
  theme(legend.position="top") +
  labs(title="Group 10 (#2): Economic Diversity, & Access to Economic Opportunity", x="Case Studies", y="Score (1-4)") +
  scale_fill_brewer(palette = "Pastel1")
