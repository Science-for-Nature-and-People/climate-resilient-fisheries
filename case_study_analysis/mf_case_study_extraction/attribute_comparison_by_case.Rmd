...
```{r}
attributes_merged <- rbind(aguion_barnacle, burden_sardine, dickey_collas_eur, eurich_clam, free_crab, friedman_fiji, golden_madagascar, hollowed_bering_sea, kisara_squid, kleisner_jfi, lau_png, mason_iceland, mills_lobster, pecl_lobster, schmidt_senegal, tokunaga_lobster, westfall_hms, zhao_moorea)
...
ggplot() +
  ...
  geom_hline(data=age_structure, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=genetic_diversity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=species_diversity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=adult_mobility, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=larval_dispersal, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=environmental_breadth, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=dietary_flexibility, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=habitat_diversity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=plasticity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=evolutionary_potential, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=ecosystem_connectivity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=population_modularity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=wealth_reserves, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=economic_divserity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=social_divsersity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=mobility, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=economic_opportunity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=place_attachment, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=social_capital, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=tech_transfer, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=modular_infrastrucutre, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=knowledge_diversity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme 
```
...
ggplot() +
  ...
  geom_hline(data=knowledge_access, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=learning_capacity, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=agency, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=responsive, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=participatory, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=equitable_inclusive, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=accountable, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=transparent, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=effective_efficient, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=polycentric, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=cross_scale, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=adaptive, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
...
ggplot() +
  ...
  geom_hline(data=leadership_initiative, aes(yintercept = mean(numeric_importance)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme
```
