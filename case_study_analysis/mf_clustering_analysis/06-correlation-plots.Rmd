...
# Save this table
cor_data %>% write_csv(here("case_study_analysis","mf_clustering_analysis","data","cor_data.csv"))
```

# Small-scale Fisheries correlation analyses

```{r}
small_scale_correlation <- correlation_data %>% 
...
small_scale_correlation %>% 
  kbl(caption = "Correlation between Small-scale Fisheries Score and Importance by Attribute") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover"))
```


# Large-scale Fisheries correlation analyses

```{r}
large_scale_correlation <- correlation_data %>% 
...
large_scale_correlation %>% 
  kbl(caption = "Correlation between Large-scale Fisheries Score and Importance by Attribute") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover"))
```
