...
aguion_barnacle <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1BFTzr_ITZPHZ0-tdItB13VorTMrSfI9he-nWA4SZBSo/edit#gid=429676283", 
...
########################################################################################################################
kisara_squid <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1fz-aouYW__YjretfedT13l2ttET5THh1IEYcoycnSB4/edit#gid=934077877", 
                           sheet = "UPDATED_S4_ResilienceAttributes",
                           range = "A6:P61",
                           col_names = TRUE,
                           na = c("NA","na","NAN","nan",""),
...
############################################################################################################################
westfall_hms <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1DMx0Ux9Li1LhIe4ee5bbAYtJaw1vCezziRGyeERBthY/edit#gid=932661307", 
                           sheet = "UPDATED_S4_ResilienceAttributes",
                           range = "A6:P61",
                           col_names = TRUE,
                           na = c("NA","na","NAN","nan",""),
...
save(attribs, file = here("case_study_analysis","mf_clustering_analysis","data","attribs.Rdata"))
attribs %>% write_csv(here("case_study_analysis","mf_clustering_analysis","data","attribs.csv"))

save(attributes_merged_clean, file = here("case_study_analysis","mf_clustering_analysis","data","attributes_merged_clean.Rdata"))
attributes_merged_clean %>% write_csv(here("case_study_analysis","mf_clustering_analysis","data","attributes_merged_clean.csv"))
