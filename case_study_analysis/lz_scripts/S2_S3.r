...
df_diff_score<- as.data.frame(df_significant_score_difference) %>% select(attribute_1, attribute_2, P.adj)
...
df_diff_imp<- as.data.frame(df_significant_imp_difference) %>% select(attribute_1, attribute_2, P.adj)
...
df_diff_quality<- as.data.frame(df_significant_quality_difference) %>% select(attribute_1, attribute_2, P.adj)
