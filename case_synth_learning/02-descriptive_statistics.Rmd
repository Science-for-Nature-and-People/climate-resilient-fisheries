...
# Fixed the data in Excel to perform summary statistics

```{r}
final_data <- clean_learning_data_fixed %>%
  clean_names()
```


## Build out sumamry statistic graphs

#### 2.2.1.1. - Are cultural, traditional, and historic practices observable?

```{r}
Q2211 <- final_data %>% 
  filter(row_labels == "2.2.d.d.")

# graph
ggplot(Q2211, aes(x = row_labels, y = a)) +
