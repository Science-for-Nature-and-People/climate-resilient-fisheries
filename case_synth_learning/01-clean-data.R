...
clean_learning_data <- learning_merged %>% 
  filter(question_id == c("2.2.1.1.", "2.2.3.2.", "2.3.5.3.", "2.3.5.4.")) %>% #ran into error if filtered more
  filter(question_id == c("2.3.6.1.", "2.3.7.1.", "2.4.3.5.")) %>% #ran into same error if filtered more
  filter(question_id == c("2.4.7.2.", "2.4.7.3.", "2.4.7.4.", "2.4.7.5.", 
                          "2.4.7.6.", "2.4.7.7.", "2.4.8.1.", "2.4.9.1.", "2.4.9.2.",
                          "2.4.9.3.", "2.4.9.3.", "2.5.1.1.", "2.5.2.1.", "2.5.3.1.", "2.5.4.1.",
                          "2.5.5.1.", "2.5.5.1.", "2.5.5.1.", "2.5.6.1.", "2.5.6.1.", "2.5.7.1.",
                          "2.6.1.1.", "2.6.3.1."))
